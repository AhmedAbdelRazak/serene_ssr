...
const AdminNavbarWrapper = styled.div`
  margin-bottom: 15px;
  background: ${(props) => (props.$collapsed ? "" : "#1e1e2d")};
  top: ${(props) => (props.$collapsed ? "20px" : "69px")} !important;
  z-index: 20000;
  overflow: auto;
  position: absolute;
  ...
  width: ${(props) => (props.$collapsed ? "5%" : "15%")} !important;
  ...
  li {
    /* margin: 20px auto; */
    font-size: 1rem;
    margin-bottom: ${(props) => (props.$collapsed ? "20px " : "15px")};
  }
  ...
  .ant-menu-item-selected {
    background: ${(props) => (props.$clickedOn ? "none !important" : "")};
  }
  ...
  @media (max-width: 1200px) {
    width: ${(props) => (props.$collapsed ? "20%" : "35%")} !important;
  ...
  @media (max-width: 1600px) {
    width: ${(props) => (props.$collapsed ? "5%" : "17%")} !important;
